...
namespace RTSEngine.EditorOnly
{
    ...
    public class RTSEngineEditor : EditorWindow
    {
        ...
        {
            VisualTreeAsset original = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/RTS Engine/Core/Editor/Experimental/RTSEngineEditorTemplate.uxml");
            TemplateContainer treeAsset = original.CloneTree();
            rootVisualElement.Add(treeAsset);

            StyleSheet = AssetDatabase.LoadAssetAtPath<StyleSheet>("Assets/RTS Engine/Core/Editor/Experimental/RTSEngineEditorStyles.uss");
